...
<table>
  <tr>
    <td style="width: 50%; vertical-align: top;">
      The audit viewer (<code>http://localhost:3092/?tab=audit</code>) displays Samba activity logs in real time. It allows filtering by user, IP, action and status, pagination, and export to PDF.
    </td>
    <td style="width: 50%; vertical-align: top;">
      El visor de auditoría (<code>http://localhost:3092/?tab=audit</code>) muestra los logs de actividad de Samba en tiempo real. Permite filtrar por usuario, IP, acción y estado, paginación y exportación a PDF.
    </td>
  </tr>
</table>
